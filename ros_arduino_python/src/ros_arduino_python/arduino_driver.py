...
class Arduino:
    ...
    def __init__(self, port="/dev/ttyUSB0", baudrate=57600, timeout=0.5):
        ...
        self.PID_RATE = 10 # Do not change this!  It is a fixed property of the Arduino PID controller.     self.PID_RATE = 30
        self.PID_INTERVAL = 1000 / 10 #self.PID_INTERVAL = 1000 / 30
